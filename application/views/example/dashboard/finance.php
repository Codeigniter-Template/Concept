...
<div class="dashboard-wrapper">
    ...
    <script src="<?= base_url('assets'); ?>/vendor/charts/chartist-bundle/Chartistjs.js"></script>
    <script src="<?= base_url('assets'); ?>/vendor/charts/chartist-bundle/chartist-plugin-threshold.js"></script>
    <!-- chart C3 js -->
    ...
    <script src="<?= base_url('assets'); ?>/libs/js/dashboard-finance.js"></script>
    <!-- main js -->
    <script src="<?= base_url('assets'); ?>/libs/js/main-js.js"></script>
    <!-- gauge js -->
    <script src="<?= base_url('assets'); ?>/vendor/gauge/gauge.min.js"></script>
    <!-- morris js -->
    ...
    <script src="<?= base_url('assets'); ?>/vendor/charts/morris-bundle/morrisjs.html"></script>
    <!-- daterangepicker js -->
