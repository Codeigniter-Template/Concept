                        ...
                        <div class="campaign-table table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="m-r-10"><img src="<?= base_url('assets'); ?>/images/dribbble.png" alt="user" width="35"></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="m-r-10"><img src="<?= base_url('assets'); ?>/images/github.png" alt="user" width="35"></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="m-r-10"><img src="<?= base_url('assets'); ?>/images/dropbox.png" alt="user" width="35"></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="m-r-10"><img src="<?= base_url('assets'); ?>/images/bitbucket.png" alt="user" width="30"></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="m-r-10"><img src="<?= base_url('assets'); ?>/images/mail_chimp.png" alt="user" width="30"></div>
                                        </td>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="card campaign-card text-center">
                        <div class="card-body">
                            <div class="campaign-img"><img src="<?= base_url('assets'); ?>/images/dribbble.png" alt="user" class="user-avatar-xl"></div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="card campaign-card text-center">
                        <div class="card-body">
                            <div class="campaign-img"><img src="<?= base_url('assets'); ?>/images/github.png" alt="user" class=" user-avatar-xl"></div>
                            <div class="campaign-info">
                                <h3 class="mb-1">Campaigns Name</h3>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="card campaign-card text-center">
                        <div class="card-body">
                            <div class="campaign-img"><img src="<?= base_url('assets'); ?>/images/slack.png" alt="user" class="user-avatar-xl"></div>
                            <div class="campaign-info">
                                <h3 class="mb-1">Campaigns Name</h3>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="card campaign-card text-center">
                        <div class="card-body">
                            <div class="campaign-img"><img src="<?= base_url('assets'); ?>/images/mail_chimp.png" alt="user" class="user-avatar-xl"></div>
                            <div class="campaign-info">
                                <h3 class="mb-1">Campaigns Name</h3>
